        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="col-span-1">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://github.com/Saishhhhhh/MuftCode/tree/main" target="_blank" rel="noopener noreferrer" 
              ...
              <a href="https://www.instagram.com/saishhh.exe/" target="_blank" rel="noopener noreferrer" 
                className="transition-transform hover:scale-110" 
                style={{ color: `${colors.textMuted}80` }}
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="www.linkedin.com/in/saishhhhhh" target="_blank" rel="noopener noreferrer" 
                className="transition-transform hover:scale-110" 
                style={{ color: `${colors.textMuted}80` }}
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-1 text-xs">
              ...
              <li>
                <Link to="/custom-roadmap" className="hover:underline transition-colors" style={{ color: `${colors.textMuted}90` }}>
                  Custom Roadmaps
                </Link>
              </li>
            </ul>
